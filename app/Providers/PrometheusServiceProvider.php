...
class PrometheusServiceProvider extends ServiceProvider
{
    public function register()
    {
        ...
        // Memantau jumlah data di tabel pengeluaran
        Prometheus::addGauge('Total Pengeluaran')
            ->value(fn() => \DB::table('expenses')->count());

        // Memantau total nominal uang yang keluar
        Prometheus::addGauge('Nominal Pengeluaran')
            ->value(fn() => \DB::table('expenses')->sum('jumlah'));
    }
